    ...
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <div class="panel loginbox">
                <div class="text-center margin-big padding-big-top"><h1>酒店预定系统</h1></div>
               ...
               <!--  <input type="button" class="button button-block bg-main text-big input-big" value="注册" style="margin-top:20px;" onclick="window.location.href='add_user2.jsp'"> --></div>
            </div>
            </form>          
        </div>
    </div>
