...
<ul class="choice_search">
      <li class="clearfix col-xs-3 col-lg-3 col-ms-3 "><label class="label_name ">房间类别名称：</label><input name="" type="text" class="form-control col-xs-8 col-lg-8 col-ms-8"></li>
...
<div class="h_products_list clearfix" id="Sellerber">
  <div class="Sellerber_left menu" id="menuBar">
    ...
    <div class="list_content">
     <div class="side_list">
        <div class="column_title"><h4 class="lighter smaller">房间类别类型列表</h4></div>
...
<span class="submenu">
<!-- <a href="add_product.html" name="" class="btn button_btn bg-deep-blue" title="添加房间类别"><i class="fa  fa-edit"></i>&nbsp;添加房间类别</a> -->
<a href="type_add.jsp"  class="btn button_btn bg-deep-blue" title="添加房间类别"><i class="fa  fa-edit"></i>&nbsp;添加分类</a>
</span>
 ...
 <table class="table table_list table_striped table-bordered" id="">
  ...
  <c:forEach items="${list }" var="t">
       ...
       <!--  <a onClick="member_stop(this,'10001')"  href="javascript:;" title="下架"  class="btn btn-xs btn-status">下架</a>  -->
        <a title="编辑" onclick="member_edit1('编辑','member-add.html','4','','510')" href="doUpdateBtype.do?id=${t.id }"  class="btn btn-xs btn-info" >编辑</a> 
        <a title="删除" href="deleteBtype.do?id=${t.id }"  onclick="return del(1,1,1)" class="btn btn-xs btn-delete" >删除</a>
       </td>
        </tr>
       </c:forEach>
...
function member_stop(obj,id){
	layer.confirm('确认要下架该房间类别吗？',function(index){
...
function member_start(obj,id){
	layer.confirm('确认要上架改该房间类别吗？',function(index){
