...
<div class="add_style clearfix relative">
 ...
 <ul>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>房间分类：&nbsp;&nbsp;</label><div class="Add_content col-xs-11">
  <input name="name" value="${Btype.name }" id="name" data-validate="required:请输入类别" onblur="return checkName();"  type="text"  class="col-xs-6"/>
  <input value="${Btype.id }" id="tid" type="hidden">
  </div>
