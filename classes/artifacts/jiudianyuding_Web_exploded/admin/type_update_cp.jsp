...
<div class="add_style clearfix relative">
  <!--品牌展示 当通过品牌管理添加菜品是显示该-->
 <!--  <div class="Brand_title">
  	 <div class="Brand_img"><img src="product_img/logo/458.jpg"><h3>卡姿兰</h3></div>
  </div> -->
 <ul>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>菜品分类：&nbsp;&nbsp;</label><div class="Add_content col-xs-11">
  <input name="name" value="${type.name }" id="name" data-validate="required:请输入类别" onblur="return checkName();"  type="text"  class="col-xs-6"/>
  <input value="${type.id }" id="tid" type="hidden">
  </div>
