...
<form method="post"  action="addOrderHuiFu.do" > 
<div class="add_style clearfix relative">
 <ul>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>名称：&nbsp;&nbsp;</label>
  	<div class="Add_content col-xs-11">
  	<input  type="text" class="col-xs-6" value="${house.name }" readonly="readonly"/>
  	<input name="id" type="hidden"  value="${order.id }"/>
  	</div>
  </li>
    <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>评分：&nbsp;&nbsp;</label>
     <div class="Add_content col-xs-11">
     ${order.scope }
     </div>
     </li> 
     <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>评价内容：&nbsp;&nbsp;</label>
     <div class="Add_content col-xs-11">
     ${order.pj }
     </div>
     </li> 
     ...
     <div class="Add_content col-xs-11">
     	<textarea id="editor_id" id="note" name="huifu" style="width:80%;height:100px;" ></textarea>
     </div>
     </li>
     <li>
