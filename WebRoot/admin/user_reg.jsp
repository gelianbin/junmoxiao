	 ...
	 function checkpwd(){
		...
		if(pwdc==""||pwdc!=pwd){
		 ...
		 if(tel==""||!regtel.test(tel)){
		  $("#prompt_jiazheng").html("电话号码不能为空，且以13，14，15，16，17，18，19开头的11位");
		  $("input[id=txtjiazheng]").html("");
		   $("input[id=txtjiazheng]").focus();
		  return false;
		  }else{
		   $("#prompt_jiazheng").html("电话号码格式正确！");
		  return true;
		  }
...
<body>
   ...
   <div class="type_title">注册</div>
   <form method="post" class="form-x" action="addReg.do" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">  
     <div class="clearfix cl">
		...
		<div class="clearfix cl">
		 ...
		 <div class="formControls col-9">
		  <input type="text" class="input-text" name="uname" id="username"  onblur="return checkuname()" required="required" />
		...
		<div class="clearfix cl">
		 ...
		 <div class="formControls col-9">
		  <input type="file" class="input-text" name="file" required="required"/>
		...
		<div class="clearfix cl">
		 ...
		 <div class="formControls col-9">
		  <input type="text" class="input-text"  name="email"  required="required"/>
		 </div>
		</div>
		<div class="clearfix cl">
         <label class="form-label col-2"><span class="c-red">*</span>电话：</label>
		 <div class="formControls col-9">
		  <input type="text" class="input-text"  name="tel"  id="txtjiazheng"  onblur="return checktel()" required="required"/>
		 <div  id='prompt_jiazheng' class="tips"></div>
		 </div>
		</div>
		<div class="clearfix cl"> 
         <label class="form-label col-2"><span class="c-red">*</span>密码：</label>
		 <div class="formControls col-9">
		  <input type="password" class="input-text"   id="txtPwd"   onblur="return checkpwd()" required="required"/>
		...
		<div class="clearfix cl">
		 ...
		 <div class="formControls col-9">
		  <input type="password" class="input-text"  name="pwd" id="txtConfirmPwd"   onblur="return checkpwdc()" required="required"/>
		...
		<div class="clearfix cl">
         <label class="form-label col-2"><span class="c-red">*</span>生日：</label>
		 <div class="formControls col-9">
		  <input type="text" class="input-text"  name="age" required="required" />
		 </div>
		</div>
		 <div class="clearfix cl">
