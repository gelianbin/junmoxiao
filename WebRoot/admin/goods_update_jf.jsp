...
<div class="margin inside_pages clearfix">
<form method="post"  action="updateGoods_jf.do"  enctype="multipart/form-data">
<div class="add_style clearfix relative">
 <ul>
    <li class="clearfix">
     <div class="col-xs-4">
    <label class="label_name col-xs-3"><i>*</i>礼品名称：&nbsp;&nbsp;</label> 
    ...
    <div class="Add_content col-xs-9">
   <input name="kcnum" type="text" value="${jz.kcnum }" class="col-xs-7"/><em class="Prompt"></em>
    </div>   
    </div>
    </li>
