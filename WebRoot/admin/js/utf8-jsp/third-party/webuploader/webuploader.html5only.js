...
(function( root, factory ) {
    ...
    define('widgets/upload',[
        ...
        Uploader.register({
             ...
             * @event uploadAccept
             * @param {Object} object
             * @param {Object} ret 投诉反馈端的返回数据，json格式，如果投诉反馈端不是json格式，从ret._raw中取数据，自行解析。
             * @description 当某个文件上传到投诉反馈端响应后，会派送此事件来询问投诉反馈端响应是否有效。如果此事件handler返回值为`false`, 则此文件将派送`server`类型的`uploadError`事件。
             * @for  Uploader
             */
             ...
             * @event uploadSuccess
             * @param {File} file File对象
             * @param {Object} response 投诉反馈端返回的数据
        ...
        return Html5Runtime.register( 'Transport', {
            ...
            send: function() {
                ...
                if ( binary ) {
                    ...
                    // android直接发送blob会导致投诉反馈端接收到的是空文件。
                    // bug详情。
