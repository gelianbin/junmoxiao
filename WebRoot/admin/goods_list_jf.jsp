...
<form method="post" action="vagueGoodsList_jf.do">
<div class="operation clearfix mb15 same_module">

<ul class="choice_search">

      <li class="clearfix col-xs-3 col-lg-3 col-ms-3 "><label class="label_name ">礼品名称：</label><input name="name" type="text" class="form-control col-xs-8 col-lg-8 col-ms-8"/></li>
...
<span class="submenu">
<a href="goods_add_jf.jsp"  class="btn button_btn bg-deep-blue" title="添加"><i class="fa  fa-edit"></i>&nbsp;添加</a>
</span>
  ...
  <c:forEach items="${list }" var="jz" varStatus="num">
     <tr>
       <!--  <td width="25px"><label><input type="checkbox" class="ace" ><span class="lbl"></span></label></td> -->
        ...
        <td class="td-manage">
        <a title="编辑"  href="doUpdateGoods_jf.do?id=${jz.id }"  class="btn btn-xs btn-info" >编辑</a>
        <a title="删除" href="deleteGoods_jf.do?id=${jz.id }"  onclick="return del(1,1,1)" class="btn btn-xs btn-delete" >删除</a>
       </td>
	  </tr>
	  </c:forEach> 
	  <!-- <tr>
...
<img alt="" src="../images/zhifu.png" width="600px;" height="300px;">
	...
	<td colspan="15">当前第${page.page}页；共${page.totalPage}页；总共${page.total}条记录； <c:if test="${page.page>1}">
    <a href="vagueGoodsList_jf.do?page=1" >首页</a>
    <a href="vagueGoodsList_jf.do?page=${page.page-1 }"> 上一页</a> 
    </c:if>
    	<c:if test="${page.page<page.totalPage}">
			<a href="vagueGoodsList_jf.do?page=${page.page+1 }">下一页</a>
			<a href="vagueGoodsList_jf.do?page=${page.totalPage }">末页</a>
		</c:if> 
		</td>
		</c:if>
      </tr>
...
function member_stop(obj,id){
	layer.confirm('确认要下架该礼品吗？',function(index){
...
function member_start(obj,id){
	layer.confirm('确认要上架改该礼品吗？',function(index){
