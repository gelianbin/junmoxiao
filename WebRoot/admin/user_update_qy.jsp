...
<div class="margin inside_pages clearfix">
<form method="post"  action="updateUser_qy.do" enctype="multipart/form-data">  <!--  -->
<div class="add_style clearfix relative">
 <ul>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>酒店名称：&nbsp;&nbsp;</label><div class="Add_content col-xs-11">
  <input name="tname" type="text"  class="col-xs-6" value="${user.tname }"/><input type="hidden" name="uid" value="${user.uid }">
  </div></li>
  <li class="clearfix"><label class="label_name col-xs-1"><i>*</i>地址：&nbsp;&nbsp;</label><div class="Add_content col-xs-11">
  <select name="address">
  <option value="${user.address }">${user.address }</option>
   ...
   <input name="tel" type="text" value="${user.tel }" class="col-xs-7"/>
      ...
      <div class="col-xs-4">
     <label class="label_name col-xs-3"><i>*</i>邮箱：&nbsp;&nbsp;</label> 
    <div class="Add_content col-xs-9">
    <input name="email" type="text" value="${user.email }"  class="col-xs-7"/>
    </div>   
    </div>
    </li>
