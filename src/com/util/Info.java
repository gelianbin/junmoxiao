...
public class Info {
    ...
    public static int getBetweenDayNumber_mins(String dateA, String dateB) {
		long dayNumber = 0;
	...
	public static int getBetweenDayNumber_hours(String dateA, String dateB) {
		long dayNumber = 0;
		//1小时=60分钟=3600秒=3600000
		//long mins = 60L * 1000L;
		long hours = 60L *60L * 1000L;
	...
	{
		double jf = 1025;
		System.out.println("jf=="+jf%100);
		Timestamp time = new Timestamp(System.currentTimeMillis());
	System.out.println(Info.getBetweenDayNumber("2019-01-29 14:48",  time.toString()));
		System.out.println(time.toString());
	System.out.print("day==="+Info.dayToday(time.toString(), "2019-01-30 13:48"));
